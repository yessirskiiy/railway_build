...
SOCIAL_AUTH_GITHUB_KEY = 'Ov23liFFWIpv4ZE4MXRu'
SOCIAL_AUTH_GITHUB_SECRET = '69361405e05eae55cf91f06a0b7c6baba5d7f384'
...
CELERY_BROKER_URL = os.environ.get('REDIS_URL2')
CELERY_RESULT_BACKEND = os.environ.get('REDIS_URL2')
